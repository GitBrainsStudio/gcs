...
export class PurchaseProductEditorComponent {
  constructor(
  ...
  ngOnInit(): void {
    ...
    {
      this.form.patchValue({ Title: this.purchaseProduct.Product.Title, PurchasePrice: this.purchaseProduct.Product.PurchasePrice, Count: this.purchaseProduct.Count})
    }
  }
  ...
  form = this.formBuilder.group({
    ...
    Count: new FormControl(1, { nonNullable: true, validators: [Validators.required]}),
  });
  ...
  {    
    ...
    purchaseProduct.Product.PurchasePrice = this.form.controls.PurchasePrice.value;
